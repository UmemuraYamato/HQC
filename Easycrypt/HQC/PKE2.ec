...
module type Scheme = {
  ...
  proc enc(h:pkey, s:pkey,  m:plaintext)  : ciphertext * ciphertext
  proc dec(x:skey, y:skey,  u:ciphertext, v:ciphertext) : plaintext option
}.

module type Adversary = {
  proc choose(h:pkey, s:pkey)     : plaintext * plaintext
  proc guess(u:ciphertext, v:ciphertext) : bool
}.
